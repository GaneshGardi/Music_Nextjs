...
import courseData from '../data/music_coursed.json'
  ...
  return (
    <div className='py-12 bg-gray-900'>
        ...
        <div className='mt-20 text-center'> 
            <Link href={'/courses'}
            className='px-4 py-2 rounded-lg font-semibold border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-300 transition duration-200'
